...
public class AboutUsPage {
    ...
    By aboutUsMenu = By.xpath("//a[text()='About us']");

    By modal = By.id("videoModal");

    By video = By.id("example-video_html5_api");

    By playButton = By.cssSelector(".vjs-big-play-button");

    By playPauseButton = By.cssSelector(".vjs-play-control");

    By closeButton = By.cssSelector("#videoModal .modal-footer button");

    By xButton = By.cssSelector("#videoModal .modal-header .close");
